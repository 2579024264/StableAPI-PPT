...
export const ProjectSettingsModal: React.FC<ProjectSettingsModalProps> = ({
  ...
  enableIconSubjectExtraction = false,
            ...
            {activeTab === 'project' ? (
              ...
              <div className="max-w-3xl space-y-6">
                ...
                <div className="pb-6 border-b border-gray-200 dark:border-border-primary space-y-4">
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            ...
                            {option.usesAI && (
                              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-banana-100 dark:bg-banana-900/30 text-banana-800 dark:text-banana-300">
                                <Sparkles size={12} />
                  ...
                  <div className="pl-4 border-l-4 border-banana-300 dark:border-banana-600 flex items-start gap-2">
                    <AlertTriangle size={16} className="text-banana-600 dark:text-banana-300 flex-shrink-0 mt-0.5" />
                    <p className="text-xs text-gray-700 dark:text-foreground-secondary">
