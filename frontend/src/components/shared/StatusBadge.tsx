...
const statusClassNames: Record<PageStatus, string> = {
  ...
  GENERATING_DESCRIPTION: 'bg-[#ECEFFF] dark:bg-banana-900/30 text-banana-700 dark:text-banana-300 animate-pulse',
  DESCRIPTION_GENERATED: 'bg-banana-100 dark:bg-banana-900/30 text-banana-700 dark:text-banana-300',
  QUEUED: 'bg-[#F3F1FB] dark:bg-banana-900/30 text-[#7F86A8] dark:text-banana-300 animate-pulse',
  GENERATING: 'bg-[#ECEFFF] dark:bg-banana-900/30 text-banana-700 dark:text-banana-300 animate-pulse',
