  ...
  return (
    ...
    >
      <div className="flex-shrink-0">
        <div className="w-8 h-8 bg-[#ECEFFF] dark:bg-banana-900/30 rounded-md flex items-center justify-center">
          <FileText className="w-4 h-4 text-banana-600 dark:text-banana-300" />
        </div>
      </div>
      ...
      <div className="flex items-center gap-1">
        {(file.parse_status === 'completed' || file.parse_status === 'failed') && (
          <button
            ...
            className="flex-shrink-0 p-1 text-gray-400 hover:text-banana-600 hover:bg-banana-50 rounded transition-colors disabled:opacity-50"
