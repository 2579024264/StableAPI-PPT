        ...
        page === 'ellipsis' ? (
          ...
          <button
            ...
            className={cn(buttonBase, btnSize, 'font-medium', {
              'bg-gradient-to-r from-[#AD73F6] to-[#7B83FF] text-white shadow-sm shadow-banana-500/20': page === currentPage,
              'text-[#343667] dark:text-foreground-secondary hover:bg-banana-50 dark:hover:bg-background-hover':
                page !== currentPage,
            })}
