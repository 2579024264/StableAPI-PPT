...
import { Button, Loading, useToast, useConfirm, AiRefineInput, FilePreviewModal, ReferenceFileList, MaterialSelector, ImportMarkdownModal, BrandLogo } from '@/components/shared';
...
export const DetailEditor: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(135deg,#FBF6FF_0%,#F5F4FF_46%,#F1F6FF_100%)] dark:bg-[linear-gradient(135deg,#17172D_0%,#15172B_54%,#101225_100%)] flex flex-col">
      {/* 顶栏 */}
      <header className="bg-white dark:bg-background-secondary shadow-sm dark:shadow-background-primary/30 border-b border-gray-200 dark:border-border-primary px-3 md:px-6 py-2 md:py-3 flex-shrink-0">
        <div className="flex items-center justify-between gap-2 md:gap-4">
          ...
          <div className="flex items-center gap-2 md:gap-4 flex-shrink-0">
            ...
            <BrandLogo size="sm" textClassName="text-base md:text-xl" />
