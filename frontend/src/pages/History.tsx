...
import { AlertTriangle, FolderOpen, Home, Trash2, Sun, Moon } from 'lucide-react';
import { Button, Loading, Card, Pagination, useToast, useConfirm, BrandLogo } from '@/components/shared';
...
const historyI18n = {
  zh: {
    home: { title: 'StableAPI幻灯片', actions: { createProject: '创建新项目' } },
    nav: { home: '主页' },
  ...
  en: {
    home: { title: 'StableAPI Slides', actions: { createProject: 'Create New Project' } },
    nav: { home: 'Home' },
    ...
    <div className="min-h-screen bg-[linear-gradient(135deg,#FBF6FF_0%,#F5F4FF_46%,#F1F6FF_100%)] dark:bg-[linear-gradient(135deg,#17172D_0%,#15172B_54%,#101225_100%)]">
      ...
      <nav className="h-14 md:h-16 bg-white dark:bg-background-secondary shadow-sm dark:shadow-background-primary/30 border-b border-gray-100 dark:border-border-primary">
        <div className="max-w-7xl mx-auto px-3 md:px-4 h-full flex items-center justify-between">
          <BrandLogo size="md" textClassName="text-lg md:text-xl" />
      ...
      <main className="max-w-6xl mx-auto px-3 md:px-4 py-6 md:py-8">
        ...
        {isLoading ? (
          ...
          <Card className="p-8 text-center">
            <AlertTriangle className="mx-auto mb-4 h-14 w-14 text-banana-500" />
          ...
          <Card className="p-12 text-center">
            <FolderOpen className="mx-auto mb-4 h-14 w-14 text-banana-400" />
