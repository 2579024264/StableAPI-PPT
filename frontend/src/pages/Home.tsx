...
import { BrandLogo, Button, Card, useToast, MaterialGeneratorModal, MaterialCenterModal, MaterialSelector, ReferenceFileList, ReferenceFileSelector, FilePreviewModal, HelpModal, Footer, TextStyleSelector } from '@/components/shared';
...
const homeI18n = {
  zh: {
    ...
    home: {
      title: 'StableAPI幻灯片',
      subtitle: '稳定、专业的 AI 原生演示文稿生成工作台',
      tagline: '由 StableAPI 驱动的原生 AI PPT 生成器',
      features: {
        oneClick: '一句话生成 PPT',
        naturalEdit: '自然语言修改',
        regionEdit: '指定区域编辑',
  ...
  en: {
    ...
    home: {
      title: 'StableAPI Slides',
      subtitle: 'A stable, professional AI-native presentation workspace',
      tagline: 'AI-native presentation generation powered by StableAPI',
      features: {
...
export const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(135deg,#FBF6FF_0%,#F5F4FF_46%,#F1F6FF_100%)] dark:bg-[linear-gradient(135deg,#17172D_0%,#15172B_54%,#101225_100%)] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <Button
              ...
              className="hidden sm:inline-flex hover:bg-banana-100/60 hover:shadow-sm transition-all duration-200 font-medium"
            >
            ...
            <Button
              ...
              onClick={handleOpenMaterialModal}
              className="sm:hidden hover:bg-banana-100/60 hover:shadow-sm transition-all duration-200"
            ...
            <Button
              ...
              className="text-xs md:text-sm hover:bg-banana-100/60 hover:shadow-sm transition-all duration-200 font-medium"
            >
            ...
            <Button
              ...
              onClick={() => setIsHelpModalOpen(true)}
              className="md:hidden hover:bg-banana-100/60 hover:shadow-sm transition-all duration-200"
              title={t('nav.help')}
            />
            {/* 分隔线 */}
      ...
      <main className="relative max-w-5xl mx-auto px-3 md:px-4 py-8 md:py-12">
        ...
        <div className="text-center mb-10 md:mb-16 space-y-4 md:space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/60 dark:bg-background-secondary backdrop-blur-sm rounded-full shadow-sm dark:shadow-none mb-4">
            <span><Sparkles size={20} className="text-banana-500 dark:text-banana" /></span>
            <span className="text-sm font-medium text-gray-700 dark:text-foreground-secondary">{t('home.tagline')}</span>
          </div>

          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight">
            <span className="bg-gradient-to-r from-blue-400 via-violet-400 to-purple-500 bg-clip-text text-transparent" style={{
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 md:gap-3 pt-4">
            {[
              { icon: <Sparkles size={14} className="text-banana-600 dark:text-banana" />, label: t('home.features.oneClick') },
              { icon: <FileEdit size={14} className="text-[#45B7D1] dark:text-[#7FD1E3]" />, label: t('home.features.naturalEdit') },
              { icon: <Search size={14} className="text-violet-500 dark:text-violet-300" />, label: t('home.features.regionEdit') },

              { icon: <Paperclip size={14} className="text-[#7B83FF] dark:text-[#98A0FF]" />, label: t('home.features.export') },
            ].map((feature, idx) => (
              <span
                key={idx}
                className="inline-flex items-center gap-1 px-3 py-1.5 bg-white/70 dark:bg-background-secondary backdrop-blur-sm rounded-full text-xs md:text-sm text-gray-700 dark:text-foreground-secondary border border-gray-200/50 dark:border-border-primary shadow-sm dark:shadow-none hover:shadow-md dark:hover:border-border-hover transition-all cursor-default"
              >
                {feature.icon}
                {feature.label}
              </span>
              ...
              return (
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-1.5 md:gap-2 px-3 md:px-6 py-2.5 md:py-3 rounded-lg dark:rounded-xl font-medium transition-all text-sm md:text-base touch-manipulation ${
                    activeTab === type
                      ? 'bg-gradient-to-r from-[#AD73F6] to-[#7B83FF] text-white shadow-yellow dark:shadow-lg dark:shadow-banana/20'
          ...
          <div className="mb-6 md:mb-8 pt-4 border-t border-gray-100 dark:border-border-primary">
            <div className="flex items-center justify-between mb-3 md:mb-4">
              <div className="flex items-center gap-2">
                <Palette size={18} className="text-violet-500 dark:text-banana flex-shrink-0" />
