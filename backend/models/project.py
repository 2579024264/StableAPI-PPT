...
class Project(db.Model):
    ...
    enable_icon_subject_extraction = db.Column(db.Boolean, nullable=True, default=False)  # 是否对小尺寸图标走百度智能抠图
    ...
    def to_dict(self, include_pages=False):
        ...
        data = {
            ...
            'enable_icon_subject_extraction': False if self.enable_icon_subject_extraction is None else bool(self.enable_icon_subject_extraction),
